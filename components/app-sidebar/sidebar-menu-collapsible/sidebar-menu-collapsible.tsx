    ...
    <Collapsible asChild open={isOpen} onOpenChange={setIsOpen}>
      <SidebarMenuItem>
        <CollapsibleTrigger asChild>
          <SidebarMenuButton className="hover:bg-brand-green font-bold hover:text-brand-dark data-[state=open]:bg-brand-green data-[state=open]:text-brand-dark" tooltip={item.title}>
            {item.icon && item.icon}

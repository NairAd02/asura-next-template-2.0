...
Define the accepted behavior for the mock-backed fleet vehicle management
module in the admin panel, including vehicle validation, process-local CRUD
state, URL-backed querying, localized responsive UI flows, and required

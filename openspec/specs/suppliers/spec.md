...
## Purpose
Define the accepted behavior for the localized suppliers catalog pilot, including process-local mock CRUD, URL-synchronized querying, responsive modal workflows, and the verification evidence used to validate the hardened SDD harness.
## Requirements

...
## Purpose
Define the accepted behavior for the localized task management pilot, including
process-local mock CRUD, URL-synchronized querying, responsive modal workflows,
and focused verification evidence for the AI development harness.
## Requirements

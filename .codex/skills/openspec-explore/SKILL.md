...
- Preserve assurance profile classification: broad product intent, business
  rules, permissions, and flows route to requirements curation before
  executable OpenSpec planning and a later Implementation Approval Packet.
